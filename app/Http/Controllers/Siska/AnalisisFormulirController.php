...
class AnalisisFormulirController extends Controller
{
    /* base */
    ...
    public function index(Request $request) {
        $analisisid = $request->input('analisisid');

        $length = $request->input('length');
        $sortBy = $request->input('column');
        $orderBy = $request->input('dir');
        $searchValue = $request->input('search');
        $query = AnalisisFormulir::eloquentQuery($sortBy, $orderBy, $searchValue);

        $query = $query->where('analisisid', '=', $analisisid);
