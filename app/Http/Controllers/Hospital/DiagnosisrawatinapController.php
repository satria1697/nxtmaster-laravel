...
use App\Models\Hospital\Diagnosisrawatinap;
...
//        return $request;
    ...
    public function index(Request $request) {
        ...
        $query = Diagnosisrawatinap::eloquentQuery($sortBy, $orderBy, $searchValue);
    ...
    {
        $data = Diagnosisrawatinap::find($id);
        if (is_null($data)) {
            return Response::json([
